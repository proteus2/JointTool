...
thicknessDistGuess = [linspace(0.005,0.02,Nlam.Span(1)),...
                      linspace(0.02,0.01,sum(Nlam.Span(2:3))),...
                      linspace(0.01,0.02,sum(Nlam.Span(4:5))),...
                      linspace(0.02,0.005,Nlam.Span(6))]; 
